...
<html lang="en">
    ...
    <body>
        <%
            boolean checkErrPath = request.getAttribute("errPath") == null;


        %>
        <div class="d-flex justify-content-center hello" id="oopss">
            <div id="error-text">
                <img
                    ...
                    />
                <span>Oopss</span>
                <p class="p-a">.<%= checkErrPath == false ? "Error" : "The page you were looking for could not be found"%></p>
